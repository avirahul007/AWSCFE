locals {
  # =========================================================
  # BIG-IP 1: Networking, HA Trust (via Mgmt), and Device Group
  # =========================================================
  do_payload_bigip1 = {
    schemaVersion = "1.0.0"
    class         = "Device"
    ...
    Common = {
      ...
      # ConfigSync and Failover heartbeats remain on the high-speed Internal TMM Network
      ...
      # Device Trust established over the Management Network
      trust = {
        class          = "DeviceTrust"
        localUsername  = "admin"
        localPassword  = var.bigip_admin_password
        
        # Pointing to BIG-IP 2's Management IP to bypass TMM routing restrictions
...
# =========================================================
# DEPLOYMENT LOGIC (Execution Order)
# =========================================================
